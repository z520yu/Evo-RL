# [lenovo] Pi0.5 PiPER Dual RealSense Red Medicine Box Place Collection and Training Notes

本文档记录当前这台机器上使用两个 RealSense D405、两个 PiPER CAN 口采集“拿起红色长条药盒，放到右边的白色平台上”任务数据，并训练 Pi0.5 的命令。
...
```bash
export TASK_TEXT="Pick up the long red medicine box and place it on the white platform on the right"
```
...
export TASK_TEXT="Pick up the long red medicine box and place it on the white platform on the right"
export DATASET_ID=local/piper_red_medicine_box_to_right_white_platform_dual_rs_v1
export DATASET_ROOT=/home/lenovo/Evo-RL/piper_red_medicine_box_to_right_white_platform_dual_rs_v1
...
lerobot-dataset-report --dataset local/piper_red_medicine_box_to_right_white_platform_dual_rs_v1
```
...
RUN=pi05_piper_red_medicine_box_white_platform_dual_rs_bs32_30k
...
CUDA_VISIBLE_DEVICES=0 HF_DATASETS_CACHE=/tmp/hf/datasets HF_HUB_OFFLINE=1 HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 TOKENIZERS_PARALLELISM=false PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True lerobot-train \
  --dataset.repo_id=local/piper_red_medicine_box_to_right_white_platform_dual_rs_v1 \
  --dataset.root=/home/lenovo/Evo-RL/piper_red_medicine_box_to_right_white_platform_dual_rs_v1 \
...
```bash
/home/lenovo/Evo-RL/outputs/train/pi05_piper_red_medicine_box_white_platform_dual_rs_bs32_30k/checkpoints/030000/pretrained_model
```
...
export POLICY_PATH=/home/lenovo/Evo-RL/outputs/train/pi05_piper_red_medicine_box_white_platform_dual_rs_bs32_30k/checkpoints/020000/pretrained_model
export TASK_TEXT="Pick up the long red medicine box and place it on the white platform on the right"
export DATASET_ID=local/eval_piper_red_medicine_box_white_platform_dual_rs_policy_round1
export DATASET_ROOT=/home/lenovo/Evo-RL/eval_piper_red_medicine_box_white_platform_dual_rs_policy_round1
...
export POLICY_PATH=/home/lenovo/Evo-RL/outputs/train/pi05_piper_red_medicine_box_white_platform_dual_rs_bs32_30k/checkpoints/030000/pretrained_model
export TASK_TEXT="Pick up the long red medicine box and place it on the white platform on the right"
export DATASET_ID=local/eval_piper_red_medicine_box_white_platform_dual_rs_hil_round1
export DATASET_ROOT=/home/lenovo/Evo-RL/eval_piper_red_medicine_box_white_platform_dual_rs_hil_round1
